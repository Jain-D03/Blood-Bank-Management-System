...
<body>
  ...
  if("valid".equals(msg)){
	  %>
	  <center>
	   <font color="red size="5">Form Submitted Successfully. You will Get Notify Within 8 hours</font>
	  </center>
	   <%
  }
  %>
 ...
 <center>
    ...
    <input type="text" name="moblienumber" placeholder="Enter Number" required>
...
<h3><center>All Right Reserved @ DAG :: 2023  </center></h3>
